# Story mode — original-game CG library, ported from reference/scripts/cgs.rpy.
#
# Art files live in the base game's images.rpa (images/cg/...).
# `image s_kill_bg` is NOT ported — the mod already defines it
# (game/definitions.rpy) with the same subpixel setting.
...
transform s_kill_start:
    ...
    linear 4 xalign 0.315 yoffset 10 zoom 0.75
...
image s_kill_zoom:
    contains:
        "s_kill"
        truecenter
        xalign 0.5 yalign 0.05 zoom 2.0
    dizzy(1, 1.0)
